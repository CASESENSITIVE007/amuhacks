...
export const Timeline = ({
  ...
  return (
    (<div
      className="w-full dark   dark:bg-neutral-950 font-serif md:px-10"
      ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="  text-5xl  mb-4 text-black dark:text-white text-center ">
          TIMELINE
        </h2>
      </div>
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 gap-20">
            <div
